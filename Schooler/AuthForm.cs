    ...
    public partial class AuthForm : Form
    {
        ...
        private void AuthButton_Click(object sender, EventArgs e)
        {
            ...
            StateSingleton.getInstance().connectionString =
                $"Data Source=DESKTOP-QL85CJN\\SQLEXPRESS;Initial Catalog=schollers;Persist Security Info=True;User ID={UsernameTextBox.Text};Password={PasswordTextBox.Text};Encrypt=False";
